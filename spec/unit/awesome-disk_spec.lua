...
package.path = 'spec/mocks/?/init.lua;spec/mocks/?.lua;' .. package.path

--- find_block_parent_tests
describe("findBlockParent #unit tests", function () -- {{{
    ...
    it("Block table has nested parent", function ()
          ...
          local retval = ad:findBlockParent(block_table, "sda1")
...
describe("parseLsBlk #unit tests", function () -- {{{
    ...
    it("block table 1", function ()
          ...
          ad:parseLsBlk(_G.lsblk_info, "", nil, 0)
    ...
    it("block table 2", function ()
          lsblk_info = [[KNAME=sda FSTYPE= MOUNTPOINT= LABEL= HOTPLUG=0 PKNAME= TRAN=sata
KNAME=sda1 FSTYPE=ext3 MOUNTPOINT= LABEL= HOTPLUG=0 PKNAME=sda TRAN=]]
          
          ad:parseLsBlk(lsblk_info, "", nil, 0)
          assert.are.same({ { kname = "sda",
                              fstype = "",
                              mountpoint = "",
                              label = "",
    ...
    it("block table 3", function ()
          lsblk_info =
             [[KNAME=sda FSTYPE= MOUNTPOINT= LABEL= HOTPLUG=0 PKNAME= TRAN=sata
KNAME=sda1 FSTYPE=ext3 MOUNTPOINT= LABEL= HOTPLUG=0 PKNAME=sda TRAN=
